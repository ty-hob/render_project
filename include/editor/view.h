...
// converts a 2d vect window point to 3d vect sceene point dimension value not
// in current view is set to 0
extern vect3d window_point_to_scene_point(vect2d wp);
// returns a 2d vect form 3d vect with the values that are curently visiable on
// the view

...
float vector_length(vect3d a){
	return sqrt((a.values[0]*a.values[0])+(a.values[1]*a.values[1])+(a.values[2]*a.values[2]));
}

// claculates a 3d unit vector given 3d vect a and 3d vect b. the direction is a to b.
...
vect3d normalize(vect3d a){
	float sq = sqrt((a.values[0]*a.values[0])+(a.values[1]*a.values[1])+(a.values[2]*a.values[2]));
	a.values[0] /= sq;
	a.values[1] /= sq;
	a.values[2] /= sq;
	return a;
